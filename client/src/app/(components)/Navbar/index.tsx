    ...
    <div className='flex justify-between items-center w-full mb-7'>
        ...
        <div className='flex justify-between items-center gap-5'>
            <div className='hidden md:flex justify-between items-center gap-5'>
                ...
                <Image src="https://s3-inventorymanagement-priksh.s3.us-east-1.amazonaws.com/DALL%C2%B7E+2024-11-16+21.53.05+-+A+realistic+image+of+a+random+young+adult+male+with+short+brown+hair%2C+wearing+a+casual+shirt+and+smiling.+The+background+is+a+neutral%2C+simple+setting+.webp" alt="profile" height={50} width={50} className='rounded w-8'/>
                    <span className='font-semibold'>kshitij</span>
                </div>
            </div>
            <Link href="/settings">
