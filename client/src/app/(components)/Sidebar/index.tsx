  ...
  return (
    <div className={sidebarClassNames}>
        ...
        <div className='flex-grow mt-8'>
            ...
            <SidebarLink href='/settings' icon={CircleDollarSign} label='Settings' isCollapsed = {isSidebarCollapsed}/>
            <SidebarLink href='/expenses' icon={SlidersHorizontal} label='Expenses' isCollapsed = {isSidebarCollapsed}/>
        </div>
