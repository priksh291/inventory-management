    ...
    return (
        <div className='mx-auto pb-5 w-full'>
            ...
            <div className='flex justify-between items-center mb-6'>
                ...
                <button className='flex items-center bg-blue-500 hover:bg-blue-700 text-gray-200 font-bold py-2 px-4 rounded cursor-pointer'
                ...
                {isLoading ? (
                    ...
                    products?.map((product) => (
                        <div key={product.productId} className='border shadow rounded-md p-4 max-w-full w-full mx-auto'>
                            ...
                            <Image src={`https://s3-inventorymanagement-priksh.s3.us-east-1.amazonaws.com/product${Math.floor(Math.random() * 3) + 1}.png`} alt={product.name} height={150} width={150} className="mb-3 rounded-2xl w-36 h-36"/>
